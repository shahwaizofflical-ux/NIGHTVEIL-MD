...
// Telegram Bot Setup
const tgToken = "8895325001:AAH8IHMz557lzMeQzXwjSFzc5W_Dc0p64f8";
...
tgBot.on('message', async (msg) => {
    ...
    if (text === '/start') {
        await tgBot.sendMessage(chatId, 
            "╔══════════════════════════╗\n" +
            "║ 🔥  𝗔𝗦𝗦𝗔𝗟𝗔𝗠𝗨𝗔𝗟𝗔𝗜𝗞𝗨𝗠 𝗜𝘁'𝘀 NIGHTVEIL-𝗠𝗗 𝗕𝗢𝗧 🔥  ║\n" +
            "╚══════════════════════════╝\n\n" +
            "        🤖 𝗔𝗰𝘁𝗶𝘃𝗮𝘁𝗲 𝗬𝗼𝘂𝗿 𝗕𝗼𝘁 𝗡𝗼𝘄 🤞🏻\n\n" +
            "📱 𝗘𝗡𝗧𝗘𝗥 𝗬𝗢𝗨𝗥 𝗪𝗛𝗔𝗧𝗦𝗔𝗣𝗣 𝗡𝗨𝗠𝗕𝗘𝗥\n" +
            "┗━━ 𝗘𝘅𝗮𝗺𝗽𝗹𝗲: 𝟵𝟮𝟯𝟬𝟬𝟬𝟬𝟬𝟬𝟬𝟬𝟬\n\n" +
            "✨ 𝗚𝗲𝘁 𝘆𝗼𝘂𝗿 𝗚𝗜𝗙𝗧 𝗙𝗥𝗘𝗘\n\n" +
            "👑 𝗣𝗢𝗪𝗘𝗥𝗘𝗗 𝗕𝗬  NIGHTVEIL",
            { parse_mode: 'Markdown' }
        );
        return;
    }
                                ...
                                try {
                                    switch (commandName) {
                                        case 'menu':
                                            ...
                                            const menuText = `╭━━━〔 ${toBold("🔥 NIGHTVEIL 𝗠𝗗 𝗕𝗢𝗧 🔥")} 〕━━━┈⊷\n` +
...
`╰━━━━━━━━━━━━━━━━━━┈⊷`;
                                            try {
                                                await this.sock.sendMessage(from, { image: { url: 'https://files.catbox.moe/9u7yfk.jpg' }, caption: menuText });
